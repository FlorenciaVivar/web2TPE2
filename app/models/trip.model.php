...
class TripModel
{
    ...
    public function getAll()
    {
        ...
        ON a.id_aerolinea_fk = b.id_aerolinea");
        $query->execute();
    ...
    public function getOneTrip($id)
    {
        ...
        FROM viaje a 
        INNER JOIN aerolinea b 
        ON a.id_aerolinea_fk = b.id_aerolinea WHERE id=?');
        $query->execute([$id]);
   ...
   /*                TRAE TODOS LOS VIAJES SEGUN AEROLINEA SELECCIONADA*/
    public function getTripsByAirlinesModel($id)
    {
        $query = $this->db->prepare('SELECT a.id, a.destino, a.fecha, a.precio, a.imagenViaje, a.descripcionDestino, b.nombre AS nombreAerolinea 
        FROM viaje a 
        INNER JOIN aerolinea b 
        ON a.id_aerolinea_fk = b.id_aerolinea WHERE id_aerolinea_fk=?');
        $query->execute([$id]);
